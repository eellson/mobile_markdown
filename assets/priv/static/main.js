...
var _user$project$FileReader$fileListDecoder = function (decoder) {
...
var _user$project$FileReader$prettyPrint = function (err) {
	var _p1 = err;
	switch (_p1.ctor) {
		case 'ReadFail':
...
var _user$project$FileReader$rawBody = F2(
	function (mimeType, nf) {
		return A2(_user$project$Native_FileReader.rawBody, mimeType, nf.blob);
	});
var _user$project$FileReader$filePart = F2(
	function (name, nf) {
		return A2(_user$project$Native_FileReader.filePart, name, nf.blob);
	});
var _user$project$FileReader$readAsDataUrl = function (fileRef) {
	return _user$project$Native_FileReader.readAsDataUrl(fileRef);
};
var _user$project$FileReader$readAsArrayBuffer = function (fileRef) {
	return _user$project$Native_FileReader.readAsArrayBuffer(fileRef);
};
var _user$project$FileReader$NativeFile = F4(
	function (a, b, c, d) {
		return {name: a, size: b, mimeType: c, blob: d};
	});
var _user$project$FileReader$nativeFileDecoder = A5(
...
var _user$project$FileReader$fileParser = function (fieldName) {
	return A2(
		_elm_lang$core$Json_Decode$field,
		fieldName,
		A2(
			_elm_lang$core$Json_Decode$field,
			'files',
			_user$project$FileReader$fileListDecoder(_user$project$FileReader$nativeFileDecoder)));
};
var _user$project$FileReader$parseSelectedFiles = _user$project$FileReader$fileParser('target');
var _user$project$FileReader$onFileChange = function (msg) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'change',
		A2(_elm_lang$core$Json_Decode$map, msg, _user$project$FileReader$parseSelectedFiles));
};
...
var _user$project$Model$initialModel = function (flags) {
	return {fileToUpload: _elm_lang$core$Maybe$Nothing, flags: flags};
};
var _user$project$Model$Model = F2(
	function (a, b) {
		return {fileToUpload: a, flags: b};
	});
var _user$project$Model$Credentials = F4(
	function (a, b, c, d) {
...
var _user$project$Model$UploadComplete = function (a) {
	return {ctor: 'UploadComplete', _0: a};
};
var _user$project$Model$CredentialsResult = function (a) {
	return {ctor: 'CredentialsResult', _0: a};
};
var _user$project$Model$Files = function (a) {
	return {ctor: 'Files', _0: a};
};
var _user$project$Model$UploadAsset = {ctor: 'UploadAsset'};

var _user$project$View$editorView = function (model) {
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Model$UploadAsset),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
						...
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								...
								_0: A2(
									_elm_lang$html$Html_Events$on,
									'change',
									A2(_elm_lang$core$Json_Decode$map, _user$project$Model$Files, _user$project$FileReader$parseSelectedFiles)),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'}),
...
var _user$project$Main$credentialsDecoder = A5(
	_elm_lang$core$Json_Decode$map4,
	_user$project$Model$Credentials,
	A2(_elm_lang$core$Json_Decode$field, 'credential', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'date', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'policy', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'signature', _elm_lang$core$Json_Decode$string));
var _user$project$Main$multiPartBody = F2(
	function (creds, nf) {
...
var _user$project$Main$uploadRequest = F3(
	function (creds, file, flags) {
		return _elm_lang$http$Http$request(
			{
				method: 'POST',
				headers: {ctor: '[]'},
		...
		switch (_p0.ctor) {
			case 'UploadAsset':
				var cmd = A2(
					...
					_user$project$Model$CredentialsResult,
					A2(_elm_lang$http$Http$get, '/credentials', _user$project$Main$credentialsDecoder));
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					{
					...
					var cmd = A2(
						...
						A2(
							...
							function (file) {
								return A2(
									_elm_lang$http$Http$send,
									_user$project$Model$UploadComplete,
									A3(_user$project$Main$uploadRequest, _p0._0._0, file, model.flags));
							},
							model.fileToUpload));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$project$Main$initialState = function (flags) {
	return {
		ctor: '_Tuple2',
		_0: _user$project$Model$initialModel(flags),
...
var _user$project$Main$main = _elm_lang$html$Html$programWithFlags(
	{
		...
		view: _user$project$View$editorView,
	...
	A2(
		...
		A2(_elm_lang$core$Json_Decode$field, 'upload_url', _elm_lang$core$Json_Decode$string)));
